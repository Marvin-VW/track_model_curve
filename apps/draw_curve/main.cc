...
int main() {
    ...
    double inner_curve_radius, outer_curve_radius, dashed_length, dashed_space, 
    curved_angle_start, curved_angle_end, line_width;
    ...
    //left line
    drawArcs(image, inner_curve_radius, -line_width, dashed_length, dashed_space , curved_angle_start, curved_angle_end, true);

    //right line
    drawArcs(image, outer_curve_radius, line_width, dashed_length, dashed_space, curved_angle_start, curved_angle_end, false);
